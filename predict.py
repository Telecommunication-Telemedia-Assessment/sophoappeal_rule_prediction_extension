...
from evaluate_models_multiclass import build_transfer_learning_model
...
def main(_):
    ...
    parser.add_argument("--report_name", type=str, default="prediction_rules.json", help="report name of predictions")
    parser.add_argument("--model", type=str, default="models/rules_2_small/ResNet50_best_model.hdf5", help="model to be used")
    ...
    model = build_transfer_learning_model(modelname, num_of_classes=8)
    ...
    for image_group in chunks(images, batch_size):
        ...
        for i, image in enumerate(image_group):
            ...
            results.append({
                ...
                "predicted_class": classnames[pred.argmax()]
            })
        j += 1
    print("done")
