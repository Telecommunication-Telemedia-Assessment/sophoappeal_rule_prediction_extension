...
def main(_):
    ...
    parser.add_argument("--models_folder", default="models/rules_2_small", type=str, help="folder to store best models")
    parser.add_argument("--results_folder", default="results/rules_2_small", type=str, help="folder to store results of best models")
